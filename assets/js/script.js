...
},
{
    ...
    audioSrc: "../../audio/A Thousand Years - James Arthur.mp3", // Ganti path sesuai file kamu
    videoBgSrc: "../../videos/A Thousand Years - James Arthur.mp4", // Ganti path jika ada video background
    lyrics: [
      { time: 4.37, text: "Heart beats fast" },
      { time: 7.83, text: "Colors and promises" },
      { time: 12.35, text: "How to be brave?" },
      { time: 14.75, text: "How can I love when I'm" },
      { time: 17.66, text: "Afraid to fall?" },
      { time: 21.40, text: "But watching you stand alone" },
      { time: 26.72, text: "All of my doubt" },
      { time: 28.32, text: "Suddenly goes away somehow" },
      { time: 33.66, text: "One step closer" },
      { time: 40.28, text: "I have died every night waiting for you" },
      { time: 45.07, text: "Darling, don't be afraid, I have loved you" },
      { time: 49.32, text: "For a thousand years" },
      { time: 52.78, text: "I'd love you for a thousand more" },
      { time: 62.92, text: "Time stands still" },
      { time: 66.08, text: "Beauty in all she is" },
      { time: 70.87, text: "I will be brave" },
      { time: 73.26, text: "I will not let anything" },
      { time: 76.46, text: "Take away" },
      { time: 79.38, text: "What's standing in front of me" },
      { time: 84.17, text: "Every breath" },
      { time: 86.81, text: "Every hour has come to this" },
      { time: 92.15, text: "One step closer" },
      { time: 99.06, text: "I have died every day waiting for you" },
      { time: 103.32, text: "Darling, don't be afraid" },
      { time: 106.00, text: "I have loved you for a thousand years" },
      { time: 111.34, text: "I'd love you for a thousand more" },
      { time: 116.93, text: "And all along I believed I would find you" },
      { time: 119.32, text: "Time has brought your heart to me" },
      { time: 123.85, text: "I have loved you for a thousand years" },
      { time: 129.45, text: "I'd love you for a thousand more" },
      { time: 140.09, text: "I'd love you for a thousand-" },
      { time: 143.29, text: "I'd love you for a thousand-" },
      { time: 148.62, text: "I'd love, I'd love you-" },
      { time: 156.08, text: "One step closer" },
      { time: 164.35, text: "One step closer" },
      { time: 171.29, text: "I have died every night waiting for you" },
      { time: 175.55, text: "Darling, don't be afraid" },
      { time: 177.96, text: "I have loved you for a thousand years" },
      { time: 183.55, text: "I'd love you for a thousand more" },
      { time: 189.14, text: "And all along I believed I would find you" },
      { time: 193.65, text: "Time has brought your heart to me" },
      { time: 196.04, text: "I have loved you for a thousand years" },
      { time: 201.61, text: "I'd love you for a thousand more" }
    ]
  },
    {
        id: 3,
